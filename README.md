...
Thriving schools averaged 96.5% graduation down to At Risk schools averaging 42.3%. Every single metric moved in exactly the right direction across all four tiers. This was the strongest validation result because it showed the classifications were statistically sound at a population level, not just for individual schools.
